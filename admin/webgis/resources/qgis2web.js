...
var map = new ol.Map({
  controls: ol.control
    ...
    .extend([expandedAttribution, new geolocateControl()]),
...
map
  .getView()
  .fit(
    [14176240.743444, -179666.66726, 14192650.475711, -170046.949361],
    map.getSize()
  );
